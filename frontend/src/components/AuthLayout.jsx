...
const SLIDES = [
  ...
  {
    image:
      "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=1000&auto=format&fit=crop", // Medical/Community vibe
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 xl:p-24 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-center text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Redora Health. Secure &
            Encouraged.
          </div>
        </div>
      </div>
